...
$$\begin{align*}\sigma^2_X &= E[(X-\mu_X)^2]\\
...
.center[
$P(0 \leq X \leq 2)=$ area under the curve between 0 and 2
]
]
...
.center[
$P(X \leq 2)=$ area under the curve to the left of 2
]
]
...
- The .onfire[standard] normal distribution has mean 0 and standard deviation 1
...
# Standardizing Variables: Example I
