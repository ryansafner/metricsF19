...
- **Can't identify causal effect** controlling for `occup`!
...
- Help visualize how later methods (difference-in-difference, fixed effects, regression discontinuity, instrumental variables) help identify causal effectsp
