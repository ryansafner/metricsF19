...
```{r, fig.retina=3, fig.align="center", fig.width=13}
...
- The .shout[difference-in-difference model] (aka .shout["diff-in-diff"] or .shout[DND"]) identifies treatment effect by differencing the difference pre- and post-treatment values of $Y$ between treatment and control groups
...
```{r}
hope<-read_csv("https://metricsf19.classes.ryansafner.com/data/HOPE.csv")
hope<-hope %>%
