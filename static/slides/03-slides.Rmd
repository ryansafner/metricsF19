...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      highlightStyle: github #ocean rainbow #monokai rainbow solarized-light #tomorrow-night -blue -eighties zenburn
      highlightLines: true
...
- R itself is just a command language 
    - The `R` *app* is basically just a command line
    - You can even just use your computer's command line!<sup>.red[2]</sup>
]
...
- Not relevant yet, but once we start writing longer blocks of code, it helps to have a consistent (and human-readable!) style
