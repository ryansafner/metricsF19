...
$$R^2=\frac{ESS}{TSS} = \frac{\displaystyle \sum^n_{i=1} (\hat{Y_i}-\bar{Y})^2}{\displaystyle \sum^n_{i=1}(Y_i-\bar{Y})^2}$$

Equivalently, you can also estimate $R^2$ as: 

$$R^2=1-\frac{SSE}{TSS} = 1 - \left(\frac{\displaystyle \sum^n_{i=1} \hat{u_i}^2}{\displaystyle \sum^n_{i=1}(Y_i-\bar{Y})^2}\right)$$
