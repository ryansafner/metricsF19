...
4. Take the average of the squared deviations: add them all up and divide by $n-1$, $\frac{1}{n}\displaystyle \sum^n_{i=1} (x_i-\bar{X})^2$
5. What you have in step 4 is variance (measured in units of $X^2)$, square root to get standard deviation (measured in original units of $X$): $\sqrt{\frac{1}{n}\displaystyle \sum^n_{i=1} (x_i-\bar{X})^2}$
