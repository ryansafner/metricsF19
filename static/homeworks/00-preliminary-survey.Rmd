...
### 1. Using the following sample data: 
...
### 4. A discrete random variable $X$ has the following pdf:
...
### 5. The random variable $Y$ is normally distributed with a mean of 50 and standard deviation of 12
...
### 6 On a scale of 1 (least) to 10 (most), how anxious are you about this class? Feel free to share any specific anxieties (they have a better chance to be specifically addressed if you do!). 

\vspace{2in}

### 7. On a scale of 1 (least) to 10 (most), how familiar would you say you are with computer programming and/or statistical software? 

\vspace{2in}

### 8. List any statistical software packages (e.g. R, Microsoft Excel, Stata, SAS, SPSS, Minitab, etc.) and any programming languages (e.g. html, php, C/++, Python, LaTeX, etc.) you have had any experience with, and rate your proficiency between 1 (least) and 5 (most), if applicable. 
