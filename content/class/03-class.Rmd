...
Today we begin the long slog to your mastery of `R`. 
...
One of the best/worst things about `R` is that it is a language, meaning there are multiple ways that you can accomplish the same task. 
...
- `rep(., times =)`^[`.` is a placeholder here.] repeats an element a specified number of times
