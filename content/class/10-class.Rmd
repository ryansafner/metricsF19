...
[Problem Set 1](/assignment/01-problem-set.html) answers will be posted shortly, and the graded assignment emailed back to you.^[Sorry I've been too busy to send emails confirming that I recieved your problem set!]
...
$$\begin{align*}
	 corX,u)&=\frac{cov(X,u)}{s_X s_u}\\
	 corX,u)s_Xs_u &=cov(X,u)\\
\end{align*}$$
...
E[\hat{\beta_1}]&=\beta_1+\frac{\big[corX,u)s_xs_u\big]}{s^2_X} \\
E[\hat{\beta_1}]&=\beta_1+\frac{corX,u)s_u}{s_X} \\
E[\hat{\beta_1}]&=\beta_1+corX,u)\frac{s_u}{s_X} \\
\end{align*}$$
