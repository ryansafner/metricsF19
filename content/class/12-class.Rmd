...
*Thursday, October 3, 2019* and *Tuesday, October 8, 2019*

# Overview

We begin with some more time for you to work on the [R Practice](/r/11-r-practice) from last class. The answer key is now posted.
...
You will be finishing up [R practice problems](/r/11-r-practice.html) from last class. Answers are posted.

# New Packages Mentioned

- `infer`: for simulation for statistical inference

# Assignments: Problem Set 3 Due Thursday October 10

[Problem Set 3](/assignment/03-problem-set) is due Thursday October 10. Note there are a few questions that will not be equipped to answer until after class on Tuesday.
