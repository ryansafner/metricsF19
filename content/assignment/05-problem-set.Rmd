...
### Part A
Using the group means, write a regression equation for a regression of GDP Growth rate on Common Law, including the standard errors in parentheses below the coefficients. Define
...
### Part A
Suppose he runs the following regression:
