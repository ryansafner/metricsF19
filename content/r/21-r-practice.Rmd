...
- [<i class="fas fa-external-link-square-alt"></i> `Answer Key (html)`](/r/21-r-practice-answers.html)
- [<i class="fab fa-markdown"></i> `Answer Key (markdown)`](/r/21-r-practice-answers.Rmd)
