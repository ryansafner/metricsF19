...
Now let's try adding some color, specifically, add an `aes`thetic that maps `continent` to `color.` 
...
Redo your plot from 10 for `lifeExp` instead of `gdpPercap`.
...
Try this again for the *whole* world, but just for observations in the year 2000. 